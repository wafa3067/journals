...
export default function AlertInputDialog({
      ...
      <AlertDialog.Portal>
        ...
        >
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-md px-3 py-2 mt-2 focus:ring-2 focus:ring-blue-500 outline-none"
          />
